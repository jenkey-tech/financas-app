...
- Redesign da aba Lançamentos.
- Indicadores de resumo ficaram menores.
- Visualizar mês e Novo/editar lançamento agora ficam lado a lado.
- Botões especiais ganharam hierarquia visual:
  - + Próximo mês;
  - ⚙ Gerenciar categorias.
- Controle de pagamentos e Vencidos/próximos 7 dias ficam lado a lado.
- Área de vencidos ficou sempre visível, com mais linhas.
- Tabela de lançamentos ficou mais compacta para não empurrar informações importantes para fora da tela.
